...
import org.noear.jwitter.extend.sited.utils.Base64Util;
...
public class Utils {
    public static final String sited_host = DbSiteDApi.cfgGet("sited_host");
    ...
    public static   String addinUrl(String uri) {
        if(uri.indexOf("://")>0){
            return uri;
        }else{
            return sited_host + uri;
        }
    }
